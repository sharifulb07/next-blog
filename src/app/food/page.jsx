  ...
  return (
    <div>
      ...
      <section className="px-[10%] flex flex-col gap-[40] mb-10">
        ...
        <Image src={"https://images.unsplash.com/photo-1606787366850-de6330128bfc?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"} width={800} height={400} alt='walpaper' className='w-full h-[400px]' />
            <SectionTitle title={"Food Post"} />
